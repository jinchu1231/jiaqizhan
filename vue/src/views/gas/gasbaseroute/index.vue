 ...
 ExportBox,ToFormDetail , SuperQuery
        ...
        methods: {
            ...
            initData() {
                ...
                let _query = {
                    ...
                    ...this.defListQuery,
                        ...
                        dataType: 0,
                    menuId:this.menuId,
                    moduleId:'562562709497847685',
                    type:1,
                };
                request({
                    url: `/api/gas/GasBaseRoute/getList`,
                    method: 'post',
                    data: _query
                }).then(res => {
                    var _list =[];
            ...
            handelUpload(){
                ...
                this.$nextTick(() => {
                    this.$refs.UploadBox.init("","gas/GasBaseRoute",0,this.flowList)
                })
            },
                openSuperQuery() {
            ...
            download(data) {
                ...
                request({
                    url: `/api/gas/GasBaseRoute/Actions/Export`,
                    method: 'post',
                    data: query
                }).then(res => {
