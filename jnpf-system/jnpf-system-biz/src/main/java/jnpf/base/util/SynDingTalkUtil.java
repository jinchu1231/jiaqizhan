...
import jnpf.base.model.synthirdinfo.DingTalkUserModel;
import jnpf.message.model.OraganizeListVO;
...
//        }
     ...
     * @param listByOrder
     */
    public static void getOrganizeTreeToList(OraganizeListVO selectorVO, Map<String, OrganizeEntity> organizeList, List<OrganizeEntity> listByOrder){
        if(selectorVO.isHasChildren()) {
            ...
            while (iterator.hasNext()) {
                ...
                OrganizeEntity entity = organizeList.get(organizeSelectorVO.getId());
     ...
     * @param listByOrder
     */
    public static void getOrganizeTreeToList(OrganizeListVO selectorVO, Map<String, OrganizeEntity> organizeList, List<OrganizeEntity> listByOrder){
        if(selectorVO.isHasChildren()) {
