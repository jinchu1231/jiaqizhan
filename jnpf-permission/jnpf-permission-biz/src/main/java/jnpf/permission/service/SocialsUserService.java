...
public interface SocialsUserService extends SuperService<SocialsUserEntity> {
     ...
     * @return
     */
    List<SocialsUserVo> getLoginList(String socialId);
     ...
     * @param tenantId
     */
    void loginAutoBinding(String socialType, String socialUnionid, String socialName, String userId, String tenantId);
}
