...
//        if (entity != null) {
//            //删除文件
//            FileUtil.deleteFile(fileService.getPath(FileTypeEnum.DATABACKUP) + entity.getFileName());
...
//        boolean flag = false;
//        String path = fileService.getPath(FileTypeEnum.DATABACKUP);
//        String filePath = null;
//        String fileName = null;
//        if (DbTypeUtil.checkMySQL(dataSourceUtils)) {
//            fileName = RandomUtil.uuId() + ".sql";
//            String url = DbTypeUtil.getUrl(dataSourceUtils);
...
//                flag = true;
//            }
//        } else if (DbTypeUtil.checkSQLServer(dataSourceUtils)) {
...
//                flag = true;
//            }
//        } else if (DbTypeUtil.checkOracle(dataSourceUtils)) {
...
//        }
//        //上传到远端
//        fileUploadProvider.uploadFiles(new UploadFileModel(filePath, FileTypeEnum.DATABACKUP.toLowerCase(), fileName));
//        return flag;
//    }
//}
